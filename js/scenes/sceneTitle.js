class SceneTitle extends Phaser.Scene {
    ...
    create() {
        ...
        this.gameSound=this.sound.add('backgroundMusic', {loop: true});
        
        this.gameSound.play({volume: .02});
      ...
      //mediaManager.setBackgroundMusic("backgroundMusic");
        ...
        var flatButton = new FlatButton({scene:this,key:"menubox", text:"Start Game", x:game.config.width/2, y:(game.config.height/5) * 4, event:"button_pressed"})
      ...
      this.text1=this.add.bitmapText(game.config.width/2,game.config.height/5, 'cc', "ConnectWorks",60).setOrigin(0.5,0.5);
